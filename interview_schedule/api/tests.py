...
class ValidationTestCase(TestCase):
    def test_begin_must_before_end(self):
        ...
        appointment = AppointmentSlot(id = 1, begin = begin, end=end)
        self.assertRaises(serializers.ValidationError, beginIsBeforeEnd, appointment)
    ...
    def test_begin_is_before_end(self):
        ...
        appointment = AppointmentSlot(id = 1, begin = begin, end=end)
        result = beginIsBeforeEnd(appointment)
        self.assertEqual(appointment, result)
